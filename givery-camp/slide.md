...
## Follow me!
- Twitter: [@maximum_80](https://twitter.com/maximum_80)
- Facebook: [maximum80](https://facebook.com/maximum80)
...
- Who is he?<!-- .element: class="fragment" data-fragment-index="1" -->
- William Henry "Bill" Gates III<!-- .element: class="fragment" data-fragment-index="2" -->


<!-- .slide: data-background-image="http://netgeek.biz/wp-content/uploads/2015/11/facebook_mark_zuckerberg.jpg" -->
- Who is he?<!-- .element: class="fragment" data-fragment-index="1" -->
- Mark Elliot Zuckerberg<!-- .element: class="fragment" data-fragment-index="2" -->


<!-- .slide: data-background-image="https://s3-ap-northeast-1.amazonaws.com/storage.withnews.jp/2014/09/15/9/db/9dbea4a4-l.jpg" -->
- Who is he?<!-- .element: class="fragment" data-fragment-index="1" -->
- Lawrence Edward "Larry" Page<!-- .element: class="fragment" data-fragment-index="2" -->


<!-- .slide: data-background-image="http://dol.ismcdn.jp/mwimgs/d/6/670m/img_d6a0908025419a05f6b1bf3abe67e8ef36634.jpg" -->
- Who is he?<!-- .element: class="fragment" data-fragment-index="1" -->
- Jeffrey Preston Bezos<!-- .element: class="fragment" data-fragment-index="2" -->
...
Note: Codeprep is an online Programming Learning service that let user learn various programming language, tools without any environment setups.


<!-- .slide: data-background-image="assets/images/codecheck.png" -->
### 2. codecheck
...
#### Me
"Sure!!(...no idea though)"
Note: But I had actually no idea what Leader-ship is when I was asked from her. So I ... googled what the leradership is
...
### "Lead" "er" "ship"
Note:
leradership is a word which combines "lead", "er", and "ship". The meaing of those are
...
<!-- .slide: data-background-image="https://upload.wikimedia.org/wikipedia/commons/9/96/Google_web_search.png" -->
### -er　〜する人
A suffix used in forming nouns designating persons from the object of their occupation


<!-- .slide: data-background-image="https://upload.wikimedia.org/wikipedia/commons/9/96/Google_web_search.png" -->
### ship　の要素、スキル
A suffix of nouns denoting condition, character, office, skill, etc.


<!-- .slide: data-background-image="http://d3fhkv6xpescls.cloudfront.net/blog/wp-content/uploads/2017/03/Leadership-chalkboard.jpg" -->
I have Skill?
Note:
hmm, I don't know what sort of skills I have.


<!-- .slide: data-background-image="http://d3fhkv6xpescls.cloudfront.net/blog/wp-content/uploads/2017/03/Leadership-chalkboard.jpg" -->
I have experience!
Note:
But I experienced a lot includes failue.  
...
### First
I held matching event in University of Tsukuba.
...
<!-- .slide: data-background-image="assets/images/swa.jpg" data-background-size="contain" -->
And it was introduced by TV news.
...
<!-- .slide: data-background-image="https://tech-camp.in/note/wp-content/uploads/%E3%82%B9%E3%82%AF%E3%83%AA%E3%83%BC%E3%83%B3%E3%82%B7%E3%83%A7%E3%83%83%E3%83%88-2016-08-10-16.52.56.png" -->
There will be 600,000 short in Japan<!-- .element: class="fragment" data-fragment-index="2" -->


I started up more "Educational" business


<!-- .slide: data-background-image="https://s-media-cache-ak0.pinimg.com/originals/1d/4d/c4/1d4dc4836eee6bc731646c1c921a2d1e.png" data-background-size="contain"-->
### CODEPREP
Online programming service


<!-- .slide: data-background-image="assets/images/dmtc1.jpg" -->
### Hackathon style event
create a product, compete with teams in 2days.


<!-- .slide: data-background-image="assets/images/dmtc2.jpg" -->
I felt we will be able to succeed
...
<!-- .slide: data-background-image="https://images.fastcompany.com/upload/paul-graham-process-375.jpg" data-background-size="contain" -->
We have taken "2370 days"


So we are in still a long way to go...
...
Note: So if you want to achieve a big goal, keep thinking and thinking
...
We had no developers after CTO left.
<!-- .slide: data-background-image="assets/images/team5.png" -->
Note: I really
...
<!-- .slide: data-background-image="assets/images/team6.jpg" -->
But our member increased little by little


### Since then...
- Hey, can I work remotely?<!-- .element: class="fragment" data-fragment-index="2" -->
- Hey, I want go back canada for 2 weeks for Xmas and new year vacation!<!-- .element: class="fragment" data-fragment-index="3" -->
- Hey, can I go to gym around noon? I can work until midnight at the day instead!<!-- .element: class="fragment" data-fragment-index="4" -->

- I always say<!-- .element: class="fragment" data-fragment-index="5" -->
- YES!!!YES!!!YES!!!YES!!!<!-- .element: class="fragment" data-fragment-index="6" -->


But...


<!-- .slide: data-background-image="assets/images/team4.png" -->
The number of team member surely increased.


<!-- .slide: data-background-image="assets/images/team3.png" -->
### Before I knew it...<!-- .element: class="fragment" data-fragment-index="2" -->
Just saying "yes" makes our team<!-- .element: class="fragment" data-fragment-index="2" -->
- looks international<!-- .element: class="fragment" data-fragment-index="3" -->
- diverse<!-- .element: class="fragment" data-fragment-index="4" -->
- good culture for work emvironment<!-- .element: class="fragment" data-fragment-index="5" -->


<!-- .slide: data-background-image="assets/images/team2.jpg" data-background-size="contain" -->
### And then...<!-- .element: class="fragment" data-fragment-index="2" -->
- We could hire experienced developer.<!-- .element: class="fragment" data-fragment-index="2" -->
- He said, "I can give you my experience, but I can learn English, and culture."<!-- .element: class="fragment" data-fragment-index="3" -->
...
- They can consider good solution instad of me.
...
## How to set a goal
- Set a "simple" goal whatever you want
- There is no "correct" answer
- Done is better than perfect


## How to achieve a big goal
- Think what CORE VALUE is
- Think for someone
- Never give up
...
- Say "YES!!!"
- Trust your team
- Don't say "how", but "why" we do!



<!-- .slide: data-background-image="http://techmemo.biz/wp-content/uploads/2017/02/codeprep4.png" -->
# CODEPREP
...
# Givery
Join us!!<br>
[https://www.wantedly.com/projects/109634](https://www.wantedly.com/projects/109634)
...
keep thinking someone except you in your life.
